...
-------------
Version 2.6
- Added P4CONFIG support.
- Fixed DLL missing problem.
- Updated API signature seen in Perforce logs.

Version 2.5
- First release from asset store since changing ownership to Perforce
